...
import { MdFilter, MdFilter1, MdFilterList, MdSearch, MdSort } from 'react-icons/md'
import AddButton from '../components/AddButton'

const SortOptions = () => {
    return (
        <div className='absolute top-8 left-0 w-full h-40 bg-primary/50 shadow-lg rounded-md'>
            <p>High to Low</p>
            <p>High to Low</p>
            <p>High to Low</p>
        </div>
...
const TransactionList = ({ list, setShowTransactionForm }) => {
    ...
    return (
        <div className=' relative  grow overflow-auto'>
            <div className='flex items-center justify-center gap-2 px-4 py-2 bg-purple-200 '>
            ...
            <div className='flex items-center justify-center gap-2  px-4 py-2 bg-purple-100 '>
                <p className='mr-6'>Type:</p>
                <label htmlFor="">
                    All
                </label>
